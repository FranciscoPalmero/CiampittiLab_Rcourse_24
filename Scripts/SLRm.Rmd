...
5 sowing dates by 1 hybrid = 5 treatments by 3 replicates in two seasons (2022 and 2023)
```{r}
df1 <- read.csv("../CiampittiLab_Rcourse_24/Data/RUE.csv") %>% 
...
We can ssume $$y_i = \beta_0 + \beta_1 x_i + \epsilon_i$$
...
Getting the sandard error for $\hat{\beta}_0$ and $\hat{\beta}_1$
```{r}
# se(\beta_1)
